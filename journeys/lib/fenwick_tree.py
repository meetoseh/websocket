...
class FenwickTree:
    ...
    by journeys are actually stored in the database to make use of transactions.
    See journey_event_fenwick_trees.md in the backend documentation for more details.
    """
